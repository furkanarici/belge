...
const adresDegisikligiTemp = fs.readFileSync("../template/adresDegisikligi.html", "utf8");
const sgkDilekceTemp = fs.readFileSync("../template/adresDegisikligiSGKDilekce.html", "utf8");
...
data.yeniAdres = "eni adres falan filan"
...
createPDF({ data, title: kararTuru, template: adresDegisikligiTemp, fileName: "adresDegisikligiKarar" });
createPDF({ data, title: "SGK Dilekçesi", template: sgkDilekceTemp, fileName: "adresDegisikligiSgkDilekce" });
